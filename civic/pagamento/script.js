...
function generateBoleto() {
    ...
    // Valores fictícios
    const valorOriginal = 130000.00; // Valor original do carro
    const percentualJuros = 7; // Juros em percentual
    ...
    const codigoBarras = " 03399.65432 10987.000000 12345.678901 4 567800123456"; // Código de barras falso.
    ...
    const pagador = "Gustavo Henrique Almeida";
    const cpfPagador = "789.456.123-00";
