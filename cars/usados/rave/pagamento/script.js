...
function generateBoleto() {
    ...
    // Valores fictícios
    const valorOriginal = 180000.00; // Valor original do carro
    const percentualJuros = 3; // Juros em percentual
    ...
    const codigoBarras = "23791.34567 89012.000000 34567.890123 1 234500123456"; // Código de barras falso.
    ...
    const pagador = " Patrícia Oliveira Mendes";
    const cpfPagador = "951.753.842-00";
