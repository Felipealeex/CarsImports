...
function generateBoleto() {
    ...
    const codigoBarras = " 03399.87654 32100.000000 65432.109876 6 789000123456"; // Código de barras falso.
    ...
    const pagador = "Carlos Eduardo Pinto";
    const cpfPagador = " 741.963.852-00";
