...
function generateBoleto() {
    ...
    const codigoBarras = "03399.76543 21000.000000 34567.890123 2 345600123456"; // Código de barras falso.
    ...
    const pagador = " Marcos Antônio Pereira";
    const cpfPagador = "654.987.321-00";
