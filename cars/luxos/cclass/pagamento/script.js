...
function generateBoleto() {
    ...
    // Valores fictícios
    const valorOriginal = 220000.00; // Valor original do carro
    const percentualJuros = 6; // Juros em percentual
    ...
    const codigoBarras = "10491.23456 78000.000000 56789.123456 1 234500987654"; // Código de barras falso.
    ...
    const pagador = " Lucas Andrade Pereira";
    const cpfPagador = "852.963.741-00";
