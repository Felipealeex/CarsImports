...
function generateBoleto() {
    ...
    const codigoBarras = "74892.10001 23450.678901 23456.789012 3 456700123456"; // Código de barras falso.
    ...
    const pagador = "Rafael Oliveira Martins";
    const cpfPagador = "369.258.147-00";
