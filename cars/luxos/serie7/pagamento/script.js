...
function generateBoleto() {
    ...
    // Valores fictícios
    const valorOriginal = 750000.00; // Valor original do carro
    const percentualJuros = 9; // Juros em percentual
    ...
    const codigoBarras = "23790.12345 67890.000001 23456.789012 4 567800123456"; // Código de barras falso.
    ...
    const pagador = " Beatriz Almeida Costa";
    const cpfPagador = " 456.123.789-00";
