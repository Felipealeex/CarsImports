...
function generateBoleto() {
    ...
    // Valores fictícios
    const valorOriginal = 210000.00; // Valor original do carro
    const percentualJuros = 8; // Juros em percentual
    ...
    const codigoBarras = "10491.65432 10000.000000 34567.890123 6 789000123456"; // Código de barras falso.
    ...
    const pagador = " Juliana Pereira da Silva";
    const cpfPagador = "258.369.147-00";
